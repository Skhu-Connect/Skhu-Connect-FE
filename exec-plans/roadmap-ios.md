...
| 대상 | 원본 |
|---|---|
| 모바일 앱 5화면 | `handoff/untitled/project/청원시스템 Mobile.dc.html` (720줄 — 1–435행 화면 마크업, 436–716행 상태·데이터·핸들러). 이 문서가 인용하는 행 번호(585·593·713 …)가 이 파일 기준으로 일치함을 확인했다. **레포 밖에 있고 버전 관리를 받지 않는다** — M1 작업 중 한 번 사라져 있었다. 지우지 말 것 |
